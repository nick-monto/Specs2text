...
# EDIT: has been edited to reflect changes to directory structure

#!/usr/bin/env bash

python ./datagen_utils/convert_librispeech.py \
...
#
# python ./datagen_utils/convert_librispeech.py \
#     --input_dir ./LibriSpeech/dev-clean \
#     --dest_dir ./LibriSpeech/dev-clean-wav \
#     --output_json ./LibriSpeech/librispeech-dev-clean-wav.json
#
# python ./datagen_utils/convert_librispeech.py \
...
#     --dest_dir /datasets/LibriSpeech/test-clean-wav \# python ./datagen_utils/convert_librispeech.py \
#     --input_dir /datasets/LibriSpeech/train-clean-360 \
#     --dest_dir /datasets/LibriSpeech/train-clean-360-wav \
#     --output_json /datasets/LibriSpeech/librispeech-train-clean-360-wav.json
#
