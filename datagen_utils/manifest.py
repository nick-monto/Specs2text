...
#EDITS: typos, include original transcript on line 106, changed sorting to desc

import json
import string
import os

from datagen_utils.text import _clean_text
            ...
            with open(manifest_path, "r", encoding="utf-8") as fh:
                ...
                for data in a:
                    ...
                    transcript_text = data[
                        ...
                        data['text_filepath'])
                    data["original_transcript"] = transcript_text
